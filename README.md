...
## Resolção de desafio da Uber

* Escolhi o desafio Email service e utilizei o Amazon SES como Email Providers, conforme opção de exemplo nas instruções. 

* O código foi escrito com foco em backend.


________________________________
# ABAIXO ESTÃO AS INFOS DO DESAFIO
